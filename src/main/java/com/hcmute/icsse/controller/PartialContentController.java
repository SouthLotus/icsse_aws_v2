...
public class PartialContentController {
	...
	public String toEditHomePage(HttpServletRequest request) throws UnsupportedEncodingException {
	...
	public String toEditPicturesPage(HttpServletRequest request) throws UnsupportedEncodingException {
		request.setCharacterEncoding("UTF-8");
		Admin adm = LoginController.getAdmin(request);
		if(adm != null) {
	...
	public String toEditContactPage(HttpServletRequest request) throws UnsupportedEncodingException {
		request.setCharacterEncoding("UTF-8");
		Admin adm = LoginController.getAdmin(request);
		if(adm != null) {
