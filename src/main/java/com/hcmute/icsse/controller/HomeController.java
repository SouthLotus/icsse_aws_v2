...
public class HomeController {
	...
	public String pictures(HttpServletRequest request) throws UnsupportedEncodingException {
		request.setCharacterEncoding("UTF-8");
		findLatestNews(request);
	...
	public String viewAllNotification(HttpServletRequest request) throws UnsupportedEncodingException {
		request.setCharacterEncoding("UTF-8");
		findLatestNews(request);
		return "listnotifications";
	}
	
	private void findLatestNews(HttpServletRequest request) throws UnsupportedEncodingException {
		request.setCharacterEncoding("UTF-8");
