...
public class LoginController {
	...
	@GetMapping("/login")
	public String toLogin(HttpServletRequest request) throws UnsupportedEncodingException {
	...
	public String admLogin(@RequestParam("uname") String uname, 
			...
			HttpServletRequest request, RedirectAttributes r) throws UnsupportedEncodingException {
	...
	public static Admin getAdmin(HttpServletRequest request) throws UnsupportedEncodingException {
		request.setCharacterEncoding("UTF-8");
