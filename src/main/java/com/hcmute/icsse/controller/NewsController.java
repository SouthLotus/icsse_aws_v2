...
public class NewsController {
	...
	public String viewNotifications(HttpServletRequest request) throws UnsupportedEncodingException {
	...
	public String addNotifications(HttpServletRequest request) throws UnsupportedEncodingException {
		request.setCharacterEncoding("UTF-8");
		Admin adm = LoginController.getAdmin(request);
		if(adm != null) {
	...
	public String editNotification(@RequestParam String id, HttpServletRequest request) throws UnsupportedEncodingException {
		request.setCharacterEncoding("UTF-8");
		Admin adm = LoginController.getAdmin(request);
		if(adm == null) {
			return "redirect:/";
	...
	public String deleteNews(@RequestParam String id, HttpServletRequest request) throws UnsupportedEncodingException {
		request.setCharacterEncoding("UTF-8");
		Admin adm = LoginController.getAdmin(request);
		if(adm == null) {
			return "redirect:/";
	...
	public String editNews(@RequestParam String id, 
			...
			@RequestParam String ncontent, HttpServletRequest request) throws UnsupportedEncodingException {	
		request.setCharacterEncoding("UTF-8");
		Admin adm = LoginController.getAdmin(request);
		if(adm == null) {
			return "redirect:/";
	...
	@GetMapping("/updrive")
	public String toUploadDrivePage(HttpServletRequest request) throws UnsupportedEncodingException {
		request.setCharacterEncoding("UTF-8");
	...
	public String uploadDrive(@RequestParam MultipartFile nfile ,
			@RequestParam String id, HttpServletRequest request) throws UnsupportedEncodingException {
		request.setCharacterEncoding("UTF-8");
		if(LoginController.getAdmin(request) == null) {
			return "redirect:/";
		}
