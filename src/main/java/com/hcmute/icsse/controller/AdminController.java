...
public class AdminController {
	...
	@GetMapping("/logout")
	public String admLogout(HttpServletRequest request) throws UnsupportedEncodingException {
	...
	public String chnagePassword(HttpServletRequest request) throws UnsupportedEncodingException {
		request.setCharacterEncoding("UTF-8");
		Admin adm = LoginController.getAdmin(request);
		if(adm != null) {
	...
	@GetMapping("/admin")
	public String adminHome(HttpServletRequest request) throws UnsupportedEncodingException {
		request.setCharacterEncoding("UTF-8");
		Admin adm = LoginController.getAdmin(request);
		if(adm != null) {
			return "admin/index";
