...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Đặt ảnh đại diện</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Đặt ảnh đại diện</div>
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
									<form action="/upimage" method="post"
										...
										<div class="form-group">
											<div class="col-sm-offset-2 col-sm-10">
												...
												<input type="submit" name="usubmit" value="Lưu ảnh đại diện" class="btn btn-primary" />
											</div>
										</div>
